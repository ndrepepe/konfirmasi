import { importSales } from "@/app/actions/master-data";
import { SubmitButton } from "@/components/submit-button";
import type { Branch } from "@/lib/types";

export function SalesExcelImporter({ branches: _branches }: { branches: Branch[] }) {
  return (
    <div className="mt-6 border-t border-slate-200 pt-5">
      <a href="/templates/template-data-sales.xlsx" className="text-sm font-semibold text-teal-700 hover:text-teal-800">
